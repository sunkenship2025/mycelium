...
const DEPENDENCIES = {
  CLIENT_WEB: "@myceliumhq/web-client",
  CLIENT_ELECTRON: "@myceliumhq/electron-client",
  COMMON_ALL: "@myceliumhq/common-all",
  COMMON_CLIENT: "@myceliumhq/common-client",
  COMMON_SERVER: "@myceliumhq/common-server",
  ENGINE_SERVER: "@myceliumhq/engine-server",
  PLUGIN_CORE: "@myceliumhq/plugin-core",
};
