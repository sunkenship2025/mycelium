...
const _EXTENSIONS: ConfigUpdateEntry[] = [
  { default: "mycelium.mycelium" },
  { default: "mycelium.mycelium-paste-image" },
  { default: "mycelium.mycelium-markdown-shortcuts" },
  // Autocomplete & warnings when editing `mycelium.yml`
  { default: "redhat.vscode-yaml" },
  { default: "mycelium.mycelium-markdown-links", action: "REMOVE" },
  { default: "mycelium.mycelium-markdown-notes", action: "REMOVE" },
  { default: "mycelium.mycelium-markdown-preview-enhanced", action: "REMOVE" },
...
export class WorkspaceConfig {
  ...
  static workspaceFile(wsRoot: string) {
    return path.join(wsRoot, CONSTANTS.MYCELIUM_WS_NAME);
  }
...
export class Snippets {
  static filename = "mycelium.code-snippets";
