...
export type HistoryEvent = {
   ...
   * For example, for [RenameNote](https://github.com/myceliumhq/mycelium/blob/6c98d466536632530399bd45f1220ae725ff3e2f/packages/plugin-core/src/commands/RenameNoteV2a.ts#L52-L52),
...
/**
 * Keeps of lifecycle events in Mycelium.
 * You can find more details about it [here](https://wiki.mycelium.so/notes/Rp1yFBOH6BletGam.html#summary)
 */
