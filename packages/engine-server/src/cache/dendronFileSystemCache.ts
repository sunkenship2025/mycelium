import { Cache, FileSystemCache } from "@myceliumhq/common-all";
import { DLogger } from "@myceliumhq/common-server";
import fs from "fs-extra";
import _ from "lodash";

export abstract class MyceliumFileSystemCache<T extends FileSystemCache, V>
  implements Cache<string, V>
{
  ...
  private readFromFileSystem(): T {
    const ctx = "MyceliumFileSystemCache:readFromFileSystem";
