...
export enum TelemetryStatus {
  ...
  /** The user disabled telemetry using mycelium-cli */
  ...
  /** The user enabled telemetry using mycelium-cli */
  ENABLED_BY_CLI_COMMAND = "enabled by cli command",
  /** The user used mycelium-cli before setting telemetry with vscode or plugin */
...
export class SegmentClient {
  ...
  /** Legacy: If exists, Mycelium telemetry has been disabled. */
  static getDisableConfigPath() {
    return path.join(os.homedir(), CONSTANTS.MYCELIUM_NO_TELEMETRY);
  }

  /** May contain configuration for Mycelium telemetry. */
  static getConfigPath() {
    return path.join(os.homedir(), CONSTANTS.MYCELIUM_TELEMETRY);
  }
  ...
  static getStatus(): TelemetryStatus {
    // Legacy, this file would have been created if the user used the Mycelium Disable command
  ...
  constructor(_opts?: SegmentClientOpts) {
    ...
    const uuidPath = path.join(os.homedir(), CONSTANTS.MYCELIUM_ID);
