...
As `Montserrat` was already in use on the current mycelium.so website, I have included it as the header font, along with a recommended pairing from Google Fonts called `Roboto` for the body font.
