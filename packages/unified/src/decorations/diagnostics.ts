...
const RESOLVE_MESSAGE_AUTO_ONLY =
  "Please use the lightbulb, or run the Mycelium: Doctor command.";
const RESOLVE_MESSAGE =
  "Please use the lightbulb, run the Mycelium: Doctor command, or manually correct it.";
...
export function warnMissingFrontmatter() {
  const diagnostic: Diagnostic = badFrontmatter({
    message: `The frontmatter is missing. All notes in Mycelium must have a frontmatter. ${RESOLVE_MESSAGE_AUTO_ONLY}`,
