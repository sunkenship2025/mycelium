...
import { MyceliumASTTypes } from "../types";
    ...
    visit(tree, (node, index, parent) => {
      ...
      if (RemarkUtils.isWikiLink(node)) {
        if (
          ...
          (node as Node).type = MyceliumASTTypes.HTML;
    ...
    visit(
      ...
      (node: Node, _index: any, _parent: any) => {
        ...
        const lowerBoundParagraph: Paragraph = {
          type: MyceliumASTTypes.PARAGRAPH,
          children: [
            {
              type: MyceliumASTTypes.HTML,
