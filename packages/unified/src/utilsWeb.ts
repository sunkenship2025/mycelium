...
import { myceliumPub } from "./remark/myceliumPub";
...
import { MyceliumASTDest } from "./types";
...
export class MDUtilsV5Web {
      ...
      case ProcMode.FULL:
        {
          ...
          //   insertTitle = false;
          // } else {
          // const config = data.config as IntermediateMyceliumConfig;
  ...
  private static _procRehype(
    ...
    // const config = data?.engine?.config as IntermediateMyceliumConfig;
    const shouldApplyPublishRules =
