...
import { MyceliumASTNode, MyceliumASTTypes } from "./types";
...
export class PublishUtils {
  static getAbsUrlForAsset(opts: { suffix?: string; config: MyceliumConfig }) {
  ...
  static getSiteUrl = (config: MyceliumConfig) => {
