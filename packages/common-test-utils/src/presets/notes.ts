import { DEngineClient, DVault } from "@myceliumhq/common-all";
...
export const NOTE_BODY_PRESETS_V4 = {
  NOTE_REF: `![[mycelium.pro.mycelium-next-server#quickstart,1:#*]]`,
...
// presets are documented in [[Presets|mycelium://mycelium.docs/pkg.common-test-utils.ref.presets]] for easy refeerence
