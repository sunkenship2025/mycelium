...
const config = {
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [{ from: path.join("assets", "mycelium-ws"), to: "mycelium-ws" }],
    }),
    // used for mycelium.yml validation at runtime
    new CopyPlugin({
      patterns: [
        {
          from: path.join(
          ...
          to: "mycelium-yml.validator.json",
        },
      ],
    }),
    new CopyPlugin({
    ...
    ...(process.env.SKIP_SENTRY
      ...
      : [
          ...
          new SentryWebpackPlugin({
            ...
            org: "mycelium",
            project: "mycelium",
            release: "vscode@" + process.env.MYCELIUM_RELEASE_VERSION,
          ...
          new SentryWebpackPlugin({
            ...
            org: "mycelium",
            project: "mycelium",
            release: "express@" + process.env.MYCELIUM_RELEASE_VERSION,
            include: ".",
            ignore: ["node_modules", "webpack.*.js"],
          }),
        ]),
    // bundle analysis only done when enabled
    // see [[mycelium://mycelium.mycelium-site/mycelium.topic.dev.cli.package-plugin]] for usage
