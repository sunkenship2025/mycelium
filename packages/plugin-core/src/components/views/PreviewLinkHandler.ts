...
import { FileExtensionUtils, findNonNoteFile } from "@myceliumhq/common-server";
...
export class PreviewLinkHandler implements IPreviewLinkHandler {
  ...
  public async getNavigationTargetNoteForWikiLink({
    ...
    // vscode-webview://25d7783e-df29-479c-9838-386c17dbf9b6/mycelium.ref.links.target-different-vault
    //
    if (!data.href) {
