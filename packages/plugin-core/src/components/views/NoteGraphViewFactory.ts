...
export class NoteGraphPanelFactory {
  ...
  private static _ext: MyceliumExtension;
      ...
      this._panel.webview.onDidReceiveMessage(async (msg: GraphViewMessage) => {
        ...
        switch (msg.type) {
          case GraphViewMessageEnum.onSelect: {
            ...
            AnalyticsUtils.track(MYCELIUM_COMMANDS.SHOW_NOTE_GRAPH.key, {
          ...
          case GraphViewMessageEnum.configureCustomStyling: {
            ...
            AnalyticsUtils.track(MYCELIUM_COMMANDS.CONFIGURE_GRAPH_STYLES.key, {
  ...
  /**
   * If the user changes focus, then the newly in-focus Mycelium note
