...
export type ButtonHandleOpts = { quickPick: MyceliumQuickPickerV2 };

export class Selection2LinkBtn extends MyceliumBtn {
...
export class SelectionExtractBtn extends MyceliumBtn {
...
export class Selection2ItemsBtn extends MyceliumBtn {
  static create(opts: { pressed?: boolean; canToggle?: boolean }) {
    const { pressed, canToggle } = _.defaults(opts, {
      pressed: false,
      canToggle: true,
...
export class JournalBtn extends MyceliumBtn {
  static create(opts?: { pressed?: boolean; canToggle?: boolean }) {
    const { pressed, canToggle } = _.defaults(opts, {
      pressed: false,
      canToggle: true,
...
export class ScratchBtn extends MyceliumBtn {
  static create(opts: { pressed?: boolean; canToggle?: boolean }) {
    const { pressed, canToggle } = _.defaults(opts, {
      pressed: false,
      canToggle: true,
...
export class TaskBtn extends MyceliumBtn {
  static create(pressed?: boolean) {
    return new TaskBtn({
...
export class HorizontalSplitBtn extends MyceliumBtn {
  static create(pressed?: boolean) {
...
export class DirectChildFilterBtn extends MyceliumBtn {
  static create(pressed?: boolean) {
...
export class MultiSelectBtn extends MyceliumBtn {
  static create(opts: { pressed?: boolean; canToggle?: boolean }) {
    const { pressed, canToggle } = _.defaults(opts, {
      pressed: false,
      canToggle: true,
...
export class CopyNoteLinkBtn extends MyceliumBtn {
  static create(pressed?: boolean) {
    return new CopyNoteLinkBtn({
      ...
      pressed,
      // Setting this to TRUE to retain any previous behavior. Previously MyceliumBtn
...
export class VaultSelectButton extends MyceliumBtn {
  static create(opts: { pressed?: boolean; canToggle?: boolean }) {
...
export function createAllButtons(
  ...
  typesToTurnOn.map((btnType) => {
    (_.find(buttons, { type: btnType }) as MyceliumBtn).pressed = true;
  });
  return buttons;
}
