...
export enum MyceliumQuickPickState {
  /**
   * Default state
   */
  IDLE = "IDLE",
...
export type MyceliumQuickPickItemV2 = QuickPick<DNodePropsQuickInputV2>;
export type MyceliumQuickPickerV2 = MyceliumQuickPickItemV2 & {
  // --- Private State
  ...
  /**
   * Used by {@link MyceliumBtn} to store tmp state
   */
  prevValue?: string;
  /**
