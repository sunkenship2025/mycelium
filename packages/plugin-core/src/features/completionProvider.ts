...
import { DConfig, getDurationMilliseconds } from "@myceliumhq/common-server";
import {
  AnchorUtils,
  MyceliumASTDest,
  MyceliumASTTypes,
 ...
 *
 * related discussion: https://github.com/myceliumhq/mycelium/pull/3116#discussion_r902075154
 */
      ...
      if (_.isUndefined(anchor)) {
        ...
        edits.push(
          new TextEdit(
            ...
            block.type === MyceliumASTTypes.LIST
