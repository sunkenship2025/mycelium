  ...
  getTreeItem(element: MenuItem): TreeItem {
    ...
    switch (element) {
      case MenuItem.getStarted:
        ...
        url =
          "https://wiki.mycelium.so/notes/678c77d9-ef2c-4537-97b5-64556d6337f1/";
        break;

      case MenuItem.readDocs:
        iconPath = new ThemeIcon("book");
        url = "https://wiki.mycelium.so/notes/FWtrGfE4YJc3j0yMNjBn5/";
        break;

      case MenuItem.seeFaq:
        iconPath = new ThemeIcon("question");
        url =
          "https://wiki.mycelium.so/notes/683740e3-70ce-4a47-a1f4-1f140e80b558/";
        break;

      case MenuItem.reviewIssues:
        iconPath = new ThemeIcon("issues");
        url = "https://github.com/myceliumhq/mycelium/issues";
        break;

      case MenuItem.reportIssue:
        iconPath = new ThemeIcon("comment");
        url = "https://github.com/myceliumhq/mycelium/issues/new/choose";
        break;
      ...
      case MenuItem.followUs:
        ...
        url = "https://twitter.com/myceliumhq";
        break;
...
/**
 * Creates a tree view for the basic 'Help and Feedback' panel in the Mycelium
 * Custom View Container
 * @returns
 */
export default function setupHelpFeedbackTreeView(): vscode.TreeView<MenuItem> {
  return vscode.window.createTreeView(MyceliumTreeViewKey.HELP_AND_FEEDBACK, {
