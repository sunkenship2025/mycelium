import { AppNames } from "@myceliumhq/common-all";
...
export class WebTelemetryClient implements ITelemetryClient {
  ...
  /**
   * This key talks to the 'Mycelium-Web-Extension' source in Segment. NOTE: this
   * is different from the 'ide-prod' source.
   */
  private MYCELIUM_WEB_EXTENSION_SEGMENT_WRITE_KEY =
    "bgfipVUsX5lwQomfZ8uwMQnBLVGRypeJ";

  private requestConfig: AxiosRequestConfig = {
    auth: {
      username: this.MYCELIUM_WEB_EXTENSION_SEGMENT_WRITE_KEY,
      password: "",
    },
    headers: {
