...
import { Git } from "@myceliumhq/engine-server";
    ...
    [false, true].forEach((enableEngineV3) => {
      describeSingleWS(
        `WHEN enableEngineV3 is ${enableEngineV3}`,
        {
          ...
          preSetupHook: async ({ wsRoot }) => {
            const git = new Git({
              localUrl: wsRoot,
              remoteUrl:
                "https://github.com/myceliumhq/10000-markdown-files.git",
            });
            await git.clone();
          },
          modConfigCb: (config) => {
        ...
        () => {
          ...
          //Note Links: https://github.dev/myceliumhq/10000-markdown-files/note-with-links.md
          ...
          //Above note with 0 links: https://github.dev/myceliumhq/10000-markdown-files/abiogenetic.nutlet.md
          ...
          //https://github.dev/myceliumhq/10000-markdown-files/a.cappella.magnetic.recorder.md
          ...
          //https://github.dev/myceliumhq/10000-markdown-files/rich-formatting.md
