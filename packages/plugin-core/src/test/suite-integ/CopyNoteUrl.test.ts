import { ConfigUtils, MyceliumConfig } from "@myceliumhq/common-all";
import { NOTE_PRESETS_V4 } from "@myceliumhq/common-test-utils";
...
const ROOT_URL = "https://mycelium.so";
const ASSET_PREFIX = "aprefix";
function setupConfig(config: MyceliumConfig) {
