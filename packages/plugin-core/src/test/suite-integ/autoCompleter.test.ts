...
import { TestNoteFactory } from "@myceliumhq/common-test-utils";
import { DNodePropsQuickInputV2 } from "@myceliumhq/common-all";
  ...
  describe(`getNewQuickPickValue`, () => {
    describe(`WHEN we are at the first value of dropdown`, () => {
      it("THEN we should do partial completion", async () => {
        const quickPick =
          VSCodeUtils.createQuickPick<DNodePropsQuickInputV2>() as MyceliumQuickPickerV2;
