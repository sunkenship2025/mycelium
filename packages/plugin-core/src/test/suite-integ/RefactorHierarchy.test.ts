...
import { DNodeProps, DVault } from "@myceliumhq/common-all";
        ...
        runLegacyMultiWorkspaceTest({
          ...
          onInit: async () => {
            ...
            const capturedNotes = await cmd.getCapturedNotes({
              scope: undefined,
              matchRE: new RegExp("mycelium.ref"),
              engine,
            });

            // none of the captured notes should have stub: true
            // stub notes in this test are:
            // mycelium.ref, mycelium.ref.foo, mycelium.ref.bar, mycelium.ref.egg
