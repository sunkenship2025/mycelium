import { NoteChangeEntry, NoteProps } from "@myceliumhq/common-all";
      ...
      preSetupHook: async (opts) => {
        ...
        activeNote = await NoteTestUtilsV4.createNote({
          ...
          body: [
            ...
            "[[Target|mycelium://vault1/target]]", // line 9, char 26 ~ 32
            "[[Target|mycelium://vault1/target#foo]]", // line 10, 26 ~ 32
          ].join("\n"),
        });
        ...
        await NoteTestUtilsV4.createNote({
          ...
          vault: vaults[1],
          wsRoot,
          body: ["[[mycelium://vault1/target]]"].join("\n"),
        });
      },
    },
    () => {
      ...
      describe("WHEN rename is executed", () => {
        ...
        test("THEN correctly renamed at symbol position", async () => {
          ...
          const expectedBody = [
            ...
            "[[New Target|mycelium://vault1/new-target]]",
            "[[New Target|mycelium://vault1/new-target#foo]]",
          ].join("\n");
    ...
    "GIVEN note references",
    {
      preSetupHook: async (opts) => {
        ...
        activeNote = await NoteTestUtilsV4.createNote({
          ...
          body: [
            "![[target]]", // line 7, char 2 ~ 8
            "![[mycelium://vault1/target]]", // line 9, char 26 ~ 32
            "![[mycelium://vault1/target#foo]]", // line 10, 26 ~ 32
          ].join("\n"),
        });
        targetNote = await NoteTestUtilsV4.createNote({
          fname: "target",
      ...
      describe("WHEN rename is executed", () => {
        ...
        test("THEN correctly renamed at symbol position", async () => {
          ...
          const expectedBody = [
            "![[new-target]]",
            "![[mycelium://vault1/new-target]]",
            "![[mycelium://vault1/new-target#foo]]",
          ].join("\n");
          expect(active?.body).toEqual(expectedBody);
        });
