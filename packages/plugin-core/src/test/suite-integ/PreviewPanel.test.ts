    ...
    describe("and note has images", () => {
      ...
      describe("AND image is a URL", () => {
        test("THEN URL is NOT rewritten", async () => {
          const note = await makeTestNote({
            previewPanel,
            body: `![](https://org-mycelium-public-assets.s3.amazonaws.com/images/rfc-35-template-1.png)`,
          });
          expect(
            await AssertUtils.assertInString({
              body: note.body,
              match: [
                "https://org-mycelium-public-assets.s3.amazonaws.com/images/rfc-35-template-1.png",
              ],
