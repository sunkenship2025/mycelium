  ...
  describeMultiWS(
    ...
    () => {
      ...
      test("THEN conflict is detected if a non-resolving remap is in keybindings.json", async () => {
        ...
        const remapConflictCaseConfig = `// This is my awesome Mycelium Keybinding
        [
          {
            "key": "${remapCombo}",
        ...
        const conflictWithMoreArgsCaseConfig = `// This is my awesome Mycelium Keybinding
        [
          {
            "key": "${keyCombo}",
            "command": "dummyExt.cmd",
        ...
        const remapMyceliumCaseConfig = `// This is my awesome Mycelium Keybinding
        [
          {
            "key": "${remapCombo}",
            "command": "mycelium.lookupNote",
          }
        ]`;
        const myceliumWithMoreArgsCaseConfig = `// This is my awesome Mycelium Keybinding
        [
          {
            "key": "${keyCombo}",
            "command": "mycelium.lookupNote",
        ...
        [
          ...
          remapMyceliumCaseConfig,
          myceliumWithMoreArgsCaseConfig,
        ].forEach((config) => {
      ...
      test("THEN conflict is not detected if conflicting keybinding is disabled in keybindings.json", async () => {
        const { keybindingConfigPath, osName } =
          KeybindingUtils.getKeybindingConfigPath();
        const keyCombo = osName === "Darwin" ? "cmd+l" : "ctrl+l";
        const disableConflictCaseConfig = `// This is my awesome Mycelium Keybinding
        [
          {
            "key": "${keyCombo}",
            "command": "-dummyExt.cmd",
