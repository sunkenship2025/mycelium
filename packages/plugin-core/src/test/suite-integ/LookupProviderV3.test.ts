...
import { NoteTestUtilsV4, TestNoteFactory } from "@myceliumhq/common-test-utils";
import { ENGINE_HOOKS, TestEngineUtils } from "@myceliumhq/engine-test-utils";
    ...
    "GIVEN an active note with selection that contains wikilinks",
    {
      preSetupHook: async ({ vaults, wsRoot }) => {
        ...
        active = await NoteTestUtilsV4.createNote({
          ...
          wsRoot,
          fname: "active",
          body: "[[mycelium.ginger]]\n[[mycelium.dragonfruit]]\n[[mycelium.clementine]]",
        });
        ...
        await NoteTestUtilsV4.createNote({
          ...
          wsRoot,
          fname: "active-dedupe",
          body: "[[mycelium.ginger]]\n\n[[Ginger|mycelium.ginger]]\n\n[[Lots of Ginger|mycelium.ginger]]\n\n",
        });
        await NoteTestUtilsV4.createNote({
          genRandomId: true,
        ...
        await NoteTestUtilsV4.createNote({
          vault: TestEngineUtils.vault1(vaults),
          wsRoot,
          fname: "mycelium.ginger",
          body: "",
        });
        await NoteTestUtilsV4.createNote({
          vault: TestEngineUtils.vault1(vaults),
          wsRoot,
          fname: "mycelium.dragonfruit",
          body: "",
        });
        await NoteTestUtilsV4.createNote({
          vault: TestEngineUtils.vault1(vaults),
          wsRoot,
          fname: "mycelium.clementine",
          body: "",
        });
      },
    },
