...
import { MetadataService, ShowcaseEntry } from "@myceliumhq/engine-server";
...
/**
 * Class to showcase certain features of Mycelium as a toast message
 */
export class FeatureShowcaseToaster {
  /**
   * Show a toast containing information about a Mycelium Feature. Doesn't show
   * messages more than once, and it also doesn't show to new user's in their
   * first week of Mycelium.
