import { MyceliumError, getStage, isTSError } from "@myceliumhq/common-all";
import { DLogger, getDurationMilliseconds } from "@myceliumhq/common-server";
...
export type CodeCommandConstructor = {
  new (extension: IMyceliumExtension): CodeCommandInstance;
...
/**
 * Base class for all Mycelium Plugin Commands.
 *
 *
 * Generics:
