import { genUUID } from "@myceliumhq/common-all";
import { createLogger, getAllFilesWithTypes } from "@myceliumhq/common-server";
...
export class RefactorCommand extends BasicCommand<RefactorCommandOpts> {
  key: string = "mycelium.LegacyRefactorCommand";
