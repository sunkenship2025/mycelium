import { MyceliumError, ERROR_STATUS, VaultUtils } from "@myceliumhq/common-all";
 ...
 */
type CommandOutput = { error?: MyceliumError; fpath?: string };
...
export class PasteFileCommand extends BasicCommand<CommandOpts, CommandOutput> {
  key = MYCELIUM_COMMANDS.PASTE_FILE.key;
