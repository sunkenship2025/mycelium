...
export class VaultAddCommand extends BasicCommand<CommandOpts, CommandOutput> {
  key = MYCELIUM_COMMANDS.VAULT_ADD.key;
  ...
  async gatherInputs(): Promise<CommandOpts | undefined> {
    window.showWarningMessage(
      ...
      Please use Mycelium: Create New Vault to create a new vault and 
      Mycelium: Add Existing Vault to add an existing vault to your workspace.`
    );
