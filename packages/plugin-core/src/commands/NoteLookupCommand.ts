        ...
        if (event.action === "done") {
          ...
          if (data.action === "hide") {
            ...
            if (
              !_.includes(
                [
                  MyceliumQuickPickState.PENDING_NEXT_PICK,
                  MyceliumQuickPickState.FULFILLED,
                ],
                quickpick.state
              )
            ) {
