...
/**
 * Class managing the vscode native version of the Mycelium tree view - this is
 * the side panel UI that gives a tree view of the Mycelium note hierarchy
 */
@injectable()
export class NativeTreeView implements Disposable {
  ...
  async show() {
    ...
    this.treeView = window.createTreeView(MyceliumTreeViewKey.TREE_VIEW, {
