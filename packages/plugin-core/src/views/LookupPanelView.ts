...
export class LookupPanelView implements vscode.WebviewViewProvider, Disposable {
  ...
  constructor(viewModel: ILookupViewModel) {
    ...
    VSCodeUtils.setContext(MyceliumContext.SHOULD_SHOW_LOOKUP_VIEW, true);
  }

  dispose() {
    VSCodeUtils.setContext(MyceliumContext.SHOULD_SHOW_LOOKUP_VIEW, false);
  ...
  public async resolveWebviewView(
    ...
    WebViewUtils.prepareTreeView({
      ...
      key: MyceliumTreeViewKey.LOOKUP_VIEW,
      webviewView,
    });
