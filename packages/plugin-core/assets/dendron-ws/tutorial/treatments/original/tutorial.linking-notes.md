...
Mycelium supports links between your notes, which can help you organically connect your thoughts and build up a powerful and **personal** knowledge graph.

> 🌱 To create a link, just start typing [[and Mycelium will show you a list of notes in your workspace that you can link to. Try it in the editor pane now.
Example: [[tutorial]]
...
![Backlinks](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-backlinks.png)

### Explore Your Knowledge Graph

> 🌱 To get a visual representation of your notes, use the `Mycelium: Show Note Graph` command.
...
![Graph View](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-graph-view.png)
...
- Try out some additional features of links:
  ...
  - Note References - Add a section from another note with its content inlined into the current note. [References Docs](https://wiki.mycelium.so/notes/f1af56bb-db27-47ae-8406-61a98de6c78c.html#note-reference)
