...
Mycelium supports an extended Markdown syntax, which provides a lot of options for rich formatting. Take a look at some examples in this note to see what's possible. Have the preview pane opened (`Mycelium: Show Preview`) to see how these will get rendered.
...
> Sample Image Link:
> ![Mycelium Logo](/assets/images/logo_small.png)
...
![[tutorial#welcome-to-mycelium:#*]]

[References Docs](https://wiki.mycelium.so/notes/f1af56bb-db27-47ae-8406-61a98de6c78c.html#note-reference)
