...
You can interact with Mycelium using the Lookup bar. Use the **Lookup Bar** for both finding notes and creating new notes. Enter `Mycelium: Lookup` (`Ctrl+L` / `Cmd+L`) to open the [Lookup Bar](https://wiki.mycelium.so/notes/a7c3a810-28c8-4b47-96a6-8156b1524af3).

![Using Lookup to Navigate the Tutorial](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-lookup.gif)

## Create a Note

To create a note in Mycelium, do the following:
...
> 💡 **INFO:** Notes in Mycelium are just plaintext [markdown](https://wiki.mycelium.so/notes/ba97866b-889f-4ac6-86e7-bb2d97f6e376). Notes:
>
> - Live locally on your file system.
> - Are portable across operating systems and a variety of software.
> - Make importing/exporting easier, including [publishing your notes to a hosted website](https://wiki.mycelium.so/notes/4ushYTDoX0TYQ1FDtGQSg).
...
In Mycelium, this is autogenerated when the note is created and used to store metadata about each note.
...
> - See **[reserved keys in frontmatter](https://wiki.mycelium.so/notes/ffec2853-c0e0-4165-a368-339db12c8e4b)** for more information.

## Create a hierarchy for your Note

Mycelium organizes your notes into hierarchies. These are `.` ("dot" or "period") delimited Markdown files.
...
The same hierarchy in Mycelium would look like the following:
...
**[Hierarchies](https://wiki.mycelium.so/notes/f3a41725-c5e5-4851-a6ed-5f541054d409)** in Mycelium are created by having a `.` ("dot") delimiter in the file name. See [What's with the .'s?](https://wiki.mycelium.so/notes/f3a41725-c5e5-4851-a6ed-5f541054d409) for detailed information on how hierarchy works.
...
![Children](https://org-mycelium-public-assets.s3.amazonaws.com/images/children.png)
...
Read [Why Mycelium uses hierarchies](https://wiki.mycelium.so/notes/683740e3-70ce-4a47-a1f4-1f140e80b558) for detailed information on Mycelium note structure. Mycelium also allows you to change the hierarchy at a later date. Read [Refactoring in Mycelium](https://wiki.mycelium.so/notes/9MZBqhrijEM4QpZRa5t08) in case you change your mind on how to organize your notes.
