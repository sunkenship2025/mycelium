...
Let's do a brief overview on how to navigate the Mycelium User Interace (UI), which is called the **[Workbench](https://wiki.mycelium.so/notes/f7ebd4aa-8ba7-4bc5-bd00-a1efc5315f07)**.

> 💡 **TIP:** If you're unfamiliar with VS Code, the [command palette](https://code.visualstudio.com/docs/getstarted/userinterface#_command-palette) is used to quickly run commands, including Mycelium commands. To bring up the command palette, use `Ctrl+Shift+P` / `Cmd+Shift+P` and start typing the command. If you see instructions telling you to run a command, remember to bring up the command palette and type the command name to run it.

![Tutorial Mycelium Layout Dark](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-layout-2-dark.png)
...
Where you can write and edit your notes. **Notes** in Mycelium are [Markdown](https://wiki.mycelium.so/notes/ba97866b-889f-4ac6-86e7-bb2d97f6e376) files (ex. `my.note.md`).

## 2. Preview View

Shows the rendered Markdown of your currently opened note. If you close this pane, you can bring it back with the `Mycelium: Show Preview` command.
...
This shows the files and folders in your vault. A **[vault](https://wiki.mycelium.so/notes/6682fca0-65ed-402c-8634-94cd51463cc4)** stores your notes and assets (ex. images, PDFs, etc.).
...
Shows days where you've created a **[Details](https://wiki.mycelium.so/notes/ogIUqY5VDCJP28G3cAJhd)** entry. If no journal entry exists for a given day, clicking on the date in the calendar will automatically create it.

![Create Daily Journal from Calendar](https://org-mycelium-public-assets.s3.amazonaws.com/images/create-daily-journal-calendar.gif)
...
![Tree View Dark](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-tree-view-dark.png)

## 7. Backlinks Pane

This shows a list of other notes that have links to the current note opened in the editor view.

![Backlinks Dark](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-backlinks-dark.png)
