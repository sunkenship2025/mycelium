...
Mycelium extends regular Markdown with additional syntax. This covers everything in [GitHub Flavored Markdown (GFM)](https://github.github.com/gfm/) with additional features that are unique to Mycelium. Take a look at some examples in this note to see what's possible. Have the preview view opened (`Mycelium: Show Preview`) to see how these will get rendered.
...
Sample Image Link: `![Mycelium Logo](assets/images/logo_small.png)`

Result:

![Mycelium Logo](https://org-mycelium-public-assets.s3.amazonaws.com/images/tutorial-logo_small.png)

> 💡 **TIP:** This relies on the **Mycelium Paste Image** extension which is installed by default alongside Mycelium. For Linux users, you'll need to have [`xclip`](https://opensource.com/article/19/7/xclip) (or [`wl-paste`](https://github.com/bugaevc/wl-clipboard) if using Wayland) installed.

## Equations

Math typesetting can be written through [Katex](https://wiki.mycelium.so/notes/b1919663-cc48-4054-b0cf-4b26fe444907.html)
...
**[Note References](https://wiki.mycelium.so/notes/f1af56bb-db27-47ae-8406-61a98de6c78c)** are unique to Mycelium. You can embed a section of a different note, and have the content in-lined into the current note.
...
> 💡 **TIP:** Note references can get more fine-grained, targeting headers, sections, or blocks of text. You can learn more from the docs in [Note References](https://wiki.mycelium.so/notes/f1af56bb-db27-47ae-8406-61a98de6c78c).
