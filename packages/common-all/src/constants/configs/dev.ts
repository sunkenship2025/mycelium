...
import { MyceliumDevConfig } from "../../types/configs/dev/MyceliumDevConfig";

export const DEV: MyceliumConfigEntryCollection<MyceliumDevConfig> = {
  nextServerUrl: {
  ...
  enableSelfContainedVaults: {
    ...
    desc: "If enabled, Mycelium will create self contained vaults. Mycelium can still read self contained vaults even if this is disabled.",
  },
  forceWatcherType: {
