...
const GITHUB: MyceliumConfigEntryCollection<GithubConfig> = {
  cname: {
    label: "CNAME",
...
const GISCUS: MyceliumConfigEntryCollection<GiscusConfig> = {
  id: {
    label: "ID",
...
const GA: MyceliumConfigEntryCollection<GoogleAnalyticsConfig> = {
  tracking: {
    label: "Tracking",
...
const IMAGE: MyceliumConfigEntryCollection<SEOImage> = {
  url: {
    label: "URL",
    desc: "URL of image",
  },
...
const SEO: MyceliumConfigEntryCollection<SEOConfig> = {
  title: {
    label: "Title",
    desc: "Set SEO title.",
  },
...
export const PUBLISHING: MyceliumConfigEntryCollection<MyceliumPublishingConfig> =
  {
    ...
    siteRootDir: {
      label: "Site Root Dir",
      desc: "Where your site will be published, relative to the Mycelium workspace.",
    },
    siteUrl: {
      label: "Site URL",
