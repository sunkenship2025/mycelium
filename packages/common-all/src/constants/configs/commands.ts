...
import { MyceliumCommandConfig } from "../../types/configs/commands/commands";
import {
  LookupConfig,
  NoteLookupConfig,
 ...
 */
const NOTE: MyceliumConfigEntryCollection<NoteLookupConfig> = {
 ...
 */
const LOOKUP: MyceliumConfigEntryCollection<LookupConfig> = {
  note: NOTE,
};
 ...
 * Random note entries
 */
const RANDOM_NOTE: MyceliumConfigEntryCollection<RandomNoteConfig> = {
  include: {
 ...
 */
const INSERT_NOTE_LINK: MyceliumConfigEntryCollection<InsertNoteLinkConfig> = {
 ...
 */
export const INSERT_NOTE_INDEX: MyceliumConfigEntryCollection<InsertNoteIndexConfig> =
  {
    enableMarker: {
      label: `Enable Marker`,
...
const COPY_NOTE_LINK: MyceliumConfigEntryCollection<CopyNoteLinkConfig> = {
  nonNoteFile: {
    label: "Non-note file",
 ...
 */
export const COMMANDS: MyceliumConfigEntryCollection<MyceliumCommandConfig> = {
  lookup: LOOKUP,
