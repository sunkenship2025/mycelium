...
import { MyceliumWorkspaceConfig } from "../../types/configs/workspace/MyceliumWorkspaceConfig";
import { MyceliumGraphConfig } from "../../types/configs/workspace/graph";
...
const ADD_BEHAVIOR: Record<NoteAddBehaviorEnum, MyceliumConfigEntry<string>> = {
...
const GRAPH: MyceliumConfigEntryCollection<MyceliumGraphConfig> = {
  zoomSpeed: {
    label: "Zoom Speed",
...
/**
 * Given a {@link dayOfWeekNumber}, returns a {@link MyceliumConfigEntry} that holds
 * user friendly description of the first day of week behavior.
 *
 * @param value {@link dayOfWeekNumber}
 * @returns MyceliumConfigEntry
 */
// const FIRST_DAY_OF_WEEK = (
//   value: dayOfWeekNumber
// ): MyceliumConfigEntry<dayOfWeekNumber> => {
//   const dayOfWeek = [
//     "Sunday",
//     "Monday",
//     "Tuesday",
...
const JOURNAL: MyceliumConfigEntryCollection<JournalConfig> = {
  dailyDomain: {
    label: "Daily Domain",
...
const SCRATCH: MyceliumConfigEntryCollection<ScratchConfig> = {
  name: {
    label: "Scratch Name",
...
const TASK: MyceliumConfigEntryCollection<TaskConfig> = {
  name: {
    label: "Task name",
...
export const WORKSPACE: MyceliumConfigEntryCollection<MyceliumWorkspaceConfig> = {
  myceliumVersion: {
    label: "Mycelium version",
    desc: "Mycelium version. Set up by plugin.",
  },
  workspaces: {
    label: "Workspaces",
    desc: "Workspaces",
  ...
  disableTelemetry: {
    ...
    desc: `Disable telemetry that collects usage data to help improve Mycelium.`,
  },
  ...
  maxNoteLength: {
    ...
    desc: "Maximum number of characters in a note. Notes with characters exceeding this number will have some Mycelium features disabled.",
  },
  feedback: {
    label: "Feedback",
