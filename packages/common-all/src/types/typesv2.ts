...
import { Decoration, MyceliumConfig, Diagnostic } from ".";
import { IMyceliumError } from "../error";
...
import { MyceliumASTDest, ProcFlavor } from "./unified";
...
export enum ConfigureUIMessageEnum {
  ...
  "openMyceliumConfigYaml" = "openMyceliumConfigYaml",
}
