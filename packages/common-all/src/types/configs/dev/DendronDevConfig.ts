...
export type MyceliumDevConfig = {
  ...
  /**
   * Sets self contained vaults as the default vault type. Mycelium can read
...
/**
 * Generates defaults for {@link MyceliumDevConfig}
 * @returns MyceliumDevConfig
 */
export function genDefaultDevConfig(): MyceliumDevConfig | undefined {
  return;
}
