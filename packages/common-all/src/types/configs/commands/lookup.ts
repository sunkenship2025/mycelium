...
export function genDefaultLookupConfig(): LookupConfig {
  return {
    note: {
       ...
       *
       * At previous threshold of 0.5 string 'mycelium' matched
       * 'scratch.2021.06.15.104331.make-sure-seeds-are-initialized-on-startup' with score 0.42.
       * Which is too fuzzy of a match.
       *
       * 'rename' fuzzy matches 'mycelium.scratch.2020.11.07.publish-under-original-filenames' with 0.16.
       *
       * For reference
       * 'mycelium rename' matches 'mycelium.dev.design.commands.rename' with 0.001.
       *
