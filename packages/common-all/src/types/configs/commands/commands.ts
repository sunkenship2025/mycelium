 ...
 */
export type MyceliumCommandConfig = {
  lookup: LookupConfig;
...
/**
 * Generates default {@link MyceliumCommandConfig} using
 * respective default config generators that each command config implements.
 * @returns MyceliumCommandConfig
 */
export function genDefaultCommandConfig(): MyceliumCommandConfig {
  return {
