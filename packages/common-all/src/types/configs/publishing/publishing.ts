 ...
 */
export type MyceliumPublishingConfig = {
...
export type CleanMyceliumPublishingConfig = MyceliumPublishingConfig &
  Required<Pick<MyceliumPublishingConfig, "siteIndex" | "siteUrl">>;
...
export const publishingSchema = schemaForType<MyceliumPublishingConfig>()(
  z
    .object({
...
/**
 * Generate default {@link MyceliumPublishingConfig}
 * @returns MyceliumPublishingConfig
 */
export function genDefaultPublishingConfig(): MyceliumPublishingConfig {
  return {
    enableFMTitle: true,
