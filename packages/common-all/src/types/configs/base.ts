 ...
 */
export type MyceliumConfigEntry<T = any> = {
  value?: T;
  label: string;
  desc: string;
};
 ...
 * maps config properties to their respective MyceliumConfigEntry
 */
export type MyceliumConfigEntryCollection<T> = {
  [Property in keyof T]-?:
    | MyceliumConfigEntryCollection<any>
    | Record<any, MyceliumConfigEntry>
    | MyceliumConfigEntry
    | ((...args: any[]) => MyceliumConfigEntry);
};
