...
import { MyceliumError, MyceliumErrorProps, IMyceliumError } from "../error";
 ...
 * Mycelium. This error occurs when a duplicate note ID is detected during engine
 * init. It's non-fatal because most of Mycelium will still function after this
 * error.
 */
export class DuplicateNoteError extends MyceliumError<EngineInitErrorType.DUPLICATE_NOTE_ID> {
  constructor(
    opts: Omit<
      MyceliumErrorProps<EngineInitErrorType.DUPLICATE_NOTE_ID>,
