...
import { MyceliumGlobalConfig } from ".";
...
/**
 * Notes have a config property that can override a subset of {@link myceliumConfig}
 */
export type NoteLocalConfig = Partial<{
  global: Partial<
    Pick<
      MyceliumGlobalConfig,
...
export type DNodeExplicitProps = {
  ...
  created: number;
  /**
   * Override of local mycelium config
   */
...
export type DNodeProps<T = any, TCustom = any> = DNodeExplicitProps & {
  ...
  type: DNodeType;
  /**
   * Determines whether this node is a {@link stub https://wiki.mycelium.so/notes/c6fd6bc4-7f75-4cbb-8f34-f7b99bfe2d50.html#stubs}
   */
  stub?: boolean;
  /**
   @deprecated
...
/**
 * Interface for a Mycelium Note
 */
export type NoteProps = DNodeProps<any, any>;

/**
 * Mycelium note metadata
 */
export type NotePropsMeta = Omit<NoteProps, "body">;

/**
 * Mycelium note with optional custom props
 */
 ...
 * @todo see migration [[DNoteAnchorBasic|mycelium://mycelium.docs/dev.changelog#dnoteanchorbasic]]
 */
