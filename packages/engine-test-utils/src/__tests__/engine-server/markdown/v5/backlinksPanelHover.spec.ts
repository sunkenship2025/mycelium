import { ProcFlavor } from "@myceliumhq/common-all";
import { AssertUtils, TestPresetEntryV4 } from "@myceliumhq/common-test-utils";
import { BacklinkOpts, MyceliumASTDest } from "@myceliumhq/unified";
...
\`\`\``,
    ...
    //   },
    //   match: [
    //     '<span style="color:#000;background-color:#FFFF00;">[[mycelium://vault/foo]]</span>',
    //   ],
    // });
