import { TestPresetEntryV4 } from "@myceliumhq/common-test-utils";
import {
  AnchorUtils,
  MyceliumASTDest,
  Processor,
    ...
    verify: {
      [MyceliumASTDest.MD_REGULAR]: {
        ...
        [ProcFlavor.HOVER_PREVIEW]: async (opts) => {
          ...
          await checkString(
            resp.contents,
            `[alias](command:mycelium.gotoNote?${encodeURIComponent(
    ...
    verify: {
      [MyceliumASTDest.MD_REGULAR]: {
        ...
        [ProcFlavor.HOVER_PREVIEW]: async (opts) => {
          ...
          await checkString(
            resp.contents,
            `[@johndoe](command:mycelium.gotoNote?${encodeURIComponent(
              JSON.stringify(goToNoteCommandOpts)
            )})`
          );
        },
    ...
    verify: {
      [MyceliumASTDest.MD_REGULAR]: {
        ...
        [ProcFlavor.HOVER_PREVIEW]: async (opts) => {
          ...
          await checkString(
            resp.contents,
            `[#sample](command:mycelium.gotoNote?${encodeURIComponent(
              JSON.stringify(goToNoteCommandOpts)
            )})`
          );
        },
