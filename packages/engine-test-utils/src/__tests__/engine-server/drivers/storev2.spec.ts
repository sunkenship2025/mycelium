import { FileStorage } from "@myceliumhq/engine-server";
...
describe(`FileStorage tests:`, () => {
      ...
      const input = JSON.parse(`
 {
  ...
  "error": {
    "name": "MyceliumError",
    "status": "unknown",
    "payload": "[{\\"name\\":\\"MyceliumError\\",\\"status\\":\\"unknown\\",\\"payload\\":\\"{\\\\\\"fpath\\\\\\":\\\\\\"dvd.schema.yml\\\\\\",\\\\\\"message\\\\\\":\\\\\\"Schema id is missing from top level schema. Schema at fault: '{\\\\\\\\\\\\\\"id2\\\\\\\\\\\\\\":\\\\\\\\\\\\\\"dvd\\\\\\\\\\\\\\",\\\\\\\\\\\\\\"children\\\\\\\\\\\\\\":[{\\\\\\\\\\\\\\"pattern\\\\\\\\\\\\\\":\\\\\\\\\\\\\\"hi\\\\\\\\\\\\\\"}],\\\\\\\\\\\\\\"title\\\\\\\\\\\\\\":\\\\\\\\\\\\\\"dvd\\\\\\\\\\\\\\",\\\\\\\\\\\\\\"parent\\\\\\\\\\\\\\":\\\\\\\\\\\\\\"root\\\\\\\\\\\\\\"}'\\\\\\"}\\"}]"
  }
}
      `);
