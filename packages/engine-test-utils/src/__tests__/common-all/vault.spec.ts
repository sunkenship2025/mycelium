import { MyceliumError, DVault, VaultUtils } from "@myceliumhq/common-all";
...
describe("VaultUtils", () => {
  describe("getVaultByPath", () => {
    ...
    test("If no vault with exact name exists, return mycelium error", async () => {
      await runEngineTestV5(
        async ({ wsRoot }) => {
