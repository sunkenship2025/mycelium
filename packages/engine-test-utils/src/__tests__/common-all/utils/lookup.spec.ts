import { TransformedQueryString, NoteLookupUtils } from "@myceliumhq/common-all";
...
describe("NoteLookupUtils.transformQueryString tests:", () => {
  ...
  describe(`WHEN given string fully qualified with wiki link with description`, () => {
    ...
    beforeEach(() => {
      transformed = NoteLookupUtils.transformQueryString({
        query: "[[some description|mycelium://private/some.string.value]]",
      });
    });
  ...
  describe(`WHEN given string fully qualified with wiki link with description and header`, () => {
    ...
    beforeEach(() => {
      transformed = NoteLookupUtils.transformQueryString({
        query:
          "[[some description|mycelium://private.vault/some.string.value#header-val]]",
      });
    });
