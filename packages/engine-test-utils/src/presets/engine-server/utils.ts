import { NoteProps, SchemaUtils } from "@myceliumhq/common-all";
import {
  CreateNoteFactory,
  NOTE_PRESETS_V4,
  NoteTestUtilsV4,
...
export const setupMultiVaultSameFname: PreSetupHookFunction = async ({
  ...
  return NoteTestUtilsV4.createNote({
    ...
    body: [
      "[[eggs]]", // 7
      "[[mycelium://vault1/eggs]]", // 8
      "[[mycelium://vault2/eggs]]", // 9
      "[[mycelium://vaultThree/eggs]]", // 10
      "[[mycelium://vault3/eggs]]", // 11
      "",
      "the test note",
    ].join("\n"),
    wsRoot,
