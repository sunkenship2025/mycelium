...
function MyceliumVSCodeApp({ Component }: { Component: MyceliumComponent }) {
  const ctx = "MyceliumVSCodeApp";
  ...
  const logger = createLogger("MyceliumApp");
...
export type MyceliumAppProps = {
  opts: { padding: "inherit" | number | string };
  Component: MyceliumComponent;
};

function MyceliumApp(props: MyceliumAppProps) {
  return (
