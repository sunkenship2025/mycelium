...
import { createLogger, MyceliumNote } from "@myceliumhq/common-frontend";
...
const MyceliumNotePreview: MyceliumComponent = (props) => {
  const ctx = "MyceliumNotePreview";
  const logger = createLogger("MyceliumNotePreview");
  ...
  return (
    <>
      <MyceliumNote noteContent={noteRenderedBody} />
      <Button
        shape="circle"
...
export default MyceliumNotePreview;
