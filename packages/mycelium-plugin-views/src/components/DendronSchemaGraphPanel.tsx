...
import { createLogger, engineHooks } from "@myceliumhq/common-frontend";
import { MyceliumComponent } from "../types";

const MyceliumSchemaGraphPanel: MyceliumComponent = (props) => {
  const logger = createLogger("MyceliumSchemaGraphView");
...
export default MyceliumSchemaGraphPanel;
